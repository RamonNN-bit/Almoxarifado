        ...
        <div id="sidebar" class="w-64 sidebar-gradient text-white h-screen fixed transition-all duration-300 z-50 shadow-xl">
            ...
            <nav class="mt-6">
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="solicitacoes.php" class="flex items-center px-6 py-3 text-green-100 hover:text-white hover:bg-green-light hover:bg-opacity-20 transition-all duration-200 sidebar-link-active">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="hidden sm:flex items-center flex-1 max-w-md mx-4">
                        <div class="relative w-full">
                            <input type="text" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-primary focus:border-transparent" placeholder="Buscar solicitação...">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="relative">
                            ...
                            <span class="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center"><?php echo count($solicitacoes); ?></span>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="id_item" class="block text-sm font-medium text-gray-700 mb-2">
                                    <i class="fas fa-box mr-2"></i>Selecionar Item
                                </label>
                                <select id="id_item" name="id_item" required 
                                    ...
                                    <?php foreach ($itens_disponiveis as $item): ?>
                                        <option value="<?php echo $item['id']; ?>" 
                                            ...
                                            (<?php echo $item['quantidade']; ?> <?php echo htmlspecialchars($item['unidade'], ENT_QUOTES, 'UTF-8'); ?>)
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            ...
                            <div>
                                <label for="quantidade_solicitada" class="block text-sm font-medium text-gray-700 mb-2">
                                    <i class="fas fa-hashtag mr-2"></i>Quantidade Solicitada
                                </label>
                                <input type="number" id="quantidade_solicitada" name="quantidade_solicitada" required min="1"
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-primary focus:border-transparent transition-colors"
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-800">
                                                    <?php echo $solicitacao['quantidade']; ?> <?php echo htmlspecialchars($solicitacao['unidade'], ENT_QUOTES, 'UTF-8'); ?>
                                                </span>
                                            </td>
