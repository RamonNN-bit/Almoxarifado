                ...
                <form id="loginForm" action="../config/rota.php" method="POST" 
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="email" 
                               ...
                               <i class="fas fa-envelope absolute left-4 top-1/2 transform -translate-y-1/3 text-green-primary text-lg"></i>
                    </div>
                    ...
                    <div class="flex items-center justify-between text-sm">
                        <label class="flex items-center space-x-2 text-green-sage">
                            <input type="checkbox" 
                                   name="rememberMe" 
                                   id="remember"
